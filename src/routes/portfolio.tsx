...
export const Route = createFileRoute("/portfolio")({
  head: () => ({
    meta: [
      { title: "Portfolio — Art Interiorz, Nagpur" },
      {
        name: "description",
        content:
          "Bedrooms, modular kitchens, living rooms and more — explore selected interior design projects completed by Art Interiorz in Nagpur.",
      },
      { property: "og:title", content: "Our Portfolio — Art Interiorz" },
      {
        property: "og:description",
        content: "Selected residential, kitchen and hospitality interiors from our Nagpur studio.",
      },
    ],
  }),
  ...
  return (
    <SiteShell>
      <PageHero
        title="Our Portfolio"
        crumb="Portfolio"
        image="https://artinteriorz.com/wp-content/uploads/2025/12/LIVING-ROOM1.4-scaled.jpg"
      />
